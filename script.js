...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const animatedElements = document.querySelectorAll(
        '.skill-card, .project-card, .stat-item, .about-paragraph, .contact-link'
    );
...
// Observar estadísticas para animarlas cuando sean visibles
...
// Inicializar partículas en pantallas grandes
